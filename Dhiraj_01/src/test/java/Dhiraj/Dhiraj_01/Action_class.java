...
public class Action_class extends Dynamic_code{
	...
	public static void main(String[] args) throws Throwable {
		...
		//Action class : it provides user action like mouse action and keyboard action
		//steps :
		//create object of action class, it accept the argument as referance variable of webdriver interface
		//with the help of ref. var of action class object you can perform different methods
